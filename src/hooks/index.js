...
// Purpose of this imports is to Hold state and check for lifecycles change
// To update virtualDOM & React Tree
          ...
          setTasks(
            selectedProject === "NEXT_7" 
              ? newTasks.filter(
                ...
                .diff(moment(), 'days') <= 7 && task.archived !== true): 
